#The following code constructs Plot 4
...
#3rd plot
plot(house_power_file$DateTime, house_power_file$Voltage,
     type="l", xlab="datetime", ylab="Voltage")

#4th plot
plot(house_power_file$DateTime, as.numeric(house_power_file[,4])/1000,
